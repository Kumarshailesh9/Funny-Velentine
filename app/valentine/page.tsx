...
export default function ValentinePage() {
    ...
    const herName = nameFromQuery
        ? nameFromQuery.charAt(0).toUpperCase() + nameFromQuery.slice(1).toLowerCase()
        : "My Love";
    ...
    return (
        <div className="h-[100dvh] flex items-center justify-center bg-gradient-to-br from-pink-400 via-red-300 to-pink-500 relative overflow-hidden px-4">
            ...
            {accepted ? (
                <div className="text-center text-white z-10 animate-fadeIn">
                    ...
                    <p className="text-xl md:text-2xl">
                        This is the beginning of our beautiful story 😍✨, My heart beats for you, my soul smiles with you, and my world feels complete because of you. 💖 
                    </p>
                </div>
            ) : (
                <div
          ...
          Developed by Shailesh <a href="http://instagram.com/shailesh9.js" target="_blank">|| shailesh9.js<FaInstagramSquare />
</a>
      </footer>
